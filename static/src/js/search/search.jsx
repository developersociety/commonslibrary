...
export class Search extends React.Component {
    ...
    searchApi() {
        ...
        const tagQuery = tags.map((tag) => tag.id).join('&tags=');
        let organisationQuery = organisations
            .map((organisations) => organisations.id)
            .join('&organisation=');
    ...
    render() {
        ...
        const showSearch =
            this.state.searchOptionsSelected > 0 ||
            ...
            <div className="search-bar">
                ...
                <div className={`search-filter show-${showSearch}`}>
                    ...
                    <div className={`search-filter__groups shown-${showOrganisation}`}>
                        <div className="search-filter__type">
                            <span>Groups</span>
                            <svg className="icon">
                                <use xlinkHref="#groups" />
                            </svg>
                        </div>
                        <SearchOptionManager
                            ref={(searchOrganisations) => {
                                this.searchOrganisations = searchOrganisations;
                            }}
                ...
                {this.state.searchQuery.length > 0 && (
                    <div className="search-prompt">
                        <p>
                            Click blocks to add them to your search, or just hit return for a
                            keyword search.
                        </p>
                    </div>
                )}
